# Provision and deploy GKE cluster
...
<p align="center"><img src="./provision-and-deploy-gke-terraform.png" alt="Provision and deploy GKE cluster"></p>
...
> `bucket` value in [main.tf](https://github.com/puppetlabs/nebula-workflow-examples/blob/master/example-workflows/provision-and-deploy-gke-terraform/infra/main.tf) to the name of your bucket. For example, `bucket = "my-bucket"`
...
- name: provision-gke-with-terraform
  ...
  spec:
    ...
    directory: provision-and-deploy-gke-terraform/infra/
    credentials:
      credentials.json:
        $type: Secret
        name: credentials
